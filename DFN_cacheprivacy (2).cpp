...
main(int argc, char* argv[])
{
 ...
 Ptr<Node> Adversaries[3]   = {Names::Find<Node>("A1"),Names::Find<Node>("A2"),Names::Find<Node>("A3")};
 ...
 consumerHelper1.SetPrefix("/wikipedia.org/sub_prefix");
 ...
 */
 ...
 producerHelper.SetPrefix("/wikipedia.org/flights");
 producerHelper.SetPrefix("/wikipedia.org/sub_prefix");
 ...
 ndnGlobalRoutingHelper.AddOrigins("/wikipedia.org/flights", producers[k]);
 ndnGlobalRoutingHelper.AddOrigins("/wikipedia.org/sub_prefix", producers[k]);
